...
libdvdcss: libdvdcss (a library for accessing encryped DVDs)
libdvdcss: 
libdvdcss: libdvdcss is s library designed for accessing DVDs like a block device
libdvdcss: without having to bother about decryption.
libdvdcss: 
libdvdcss: 
libdvdcss: 
libdvdcss: 
...
source=("http://download.videolan.org/pub/libdvdcss/1.2.10/libdvdcss-1.2.10.tar.bz2")
sourcetemplate=http://thenktor.dyndns.org/packages/libdvdcss
