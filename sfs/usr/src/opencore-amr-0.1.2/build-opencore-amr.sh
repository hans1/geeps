...
opencore-amr: opencore-amr (AMR Narrowband and Wideband speech codec)
opencore-amr: 
opencore-amr: opencore-amr is a library of OpenCORE Framework implementation of
opencore-amr: Adaptive Multi Rate Narrowband and Wideband speech codec
opencore-amr: 
opencore-amr: 
opencore-amr: 
opencore-amr: 
...
source=("http://downloads.sourceforge.net/project/opencore-amr/opencore-amr/0.1.2/opencore-amr-0.1.2.tar.gz")
