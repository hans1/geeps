...
"i486-linux-thread-multi-2.6.35.10-smp" or
	die "Errno architecture (i486-linux-thread-multi-2.6.35.10-smp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
